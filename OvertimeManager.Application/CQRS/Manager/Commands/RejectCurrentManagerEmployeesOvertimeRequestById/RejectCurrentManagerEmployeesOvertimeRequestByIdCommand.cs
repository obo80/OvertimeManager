...
namespace OvertimeManager.Api.Controllers
{
    ...
    class RejectCurrentManagerEmployeesOvertimeRequestByIdCommandHandler : IRequestHandler<RejectCurrentManagerEmployeesOvertimeRequestByIdCommand>
    {
        ...
        public async Task Handle(RejectCurrentManagerEmployeesOvertimeRequestByIdCommand request, CancellationToken cancellationToken)
        {
            ...
            overtime.Status = ((StatusEnum)StatusEnum.Rejected).ToString();
